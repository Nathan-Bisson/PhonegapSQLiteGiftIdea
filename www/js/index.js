...
function init() {
	...
	//document.addEventListener("deviceready", checkDB); //uncomment for launch on phonegap
	checkDB(); //uncomment for launch in browser
}
...
//adds select list of people from db
...
//add occasion list to view page
...
//fires when list is changed to get the li value then adds the list of gift ideas for each person to the page
